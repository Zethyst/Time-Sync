...
japanese.addEventListener("click", jap = () => {
    ...
    `;
    var name = document.getElementById("japanese").getAttribute("title");
...
french.addEventListener("click", fre = () => {
    ...
    `;
    var name = document.getElementById("french").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
indian.addEventListener("click", ind = () => {
    ...
    `;
    var name = document.getElementById("indian").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
australian.addEventListener("click", aus = () => {
    ...
    holder.innerHTML = `
    <div class="flag australia" id="australian" title="Australia">
    ...
    `;
    var name = document.getElementById("australian").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
russian.addEventListener("click", rus = () => {
    ...
    `;
    var name = document.getElementById("russian").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
argentenian.addEventListener("click", arg = () => {
    ...
    `;
    var name = document.getElementById("argentenian").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
bengali.addEventListener("click", bang = () => {
    ...
    `;
    var name = document.getElementById("bengali").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
brazilian.addEventListener("click", bra = () => {
    ...
    `;
    var name = document.getElementById("brazilian").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
canadian.addEventListener("click", can = () => {
    ...
    `;
    var name = document.getElementById("canadian").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
german.addEventListener("click", ger = () => {
    ...
    `;
    var name = document.getElementById("german").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
korean.addEventListener("click", kor = () => {
    ...
    `;
    var name = document.getElementById("korean").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
lankan.addEventListener("click", sri = () => {
    ...
    `;
    document.getElementsByTagName("h3")[0].innerText = "SRI LANKA";
})
switz.addEventListener("click", swit = () => {
    ...
    var name = document.getElementById("switz").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
american.addEventListener("click", usa = () => {
    ...
    `;
    var name = document.getElementById("american").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
pakistani.addEventListener("click", pak = () => {
    ...
    var name = document.getElementById("pakistani").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
...
italian.addEventListener("click", ita = () => {
    ...
    `;
    var name = document.getElementById("italian").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
chinese.addEventListener("click", china = () => {
    ...
    `;
    var name = document.getElementById("chinese").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
...
spanish.addEventListener("click", spa = () => {
    ...
    `;
    var name = document.getElementById("spanish").getAttribute("title");
    document.getElementsByTagName("h3")[0].innerText = name;
})
